...
import { LineChart, XAxis, YAxis, CartesianGrid, Tooltip, Line, AreaChart, Area, PieChart, Pie, Cell } from "recharts";
import { Sparkles, Users, MessageCircle, Share2, TrendingUp, Calendar, Bell, Settings, Moon, Sun } from "lucide-react";

// Mock data genertion functions
...
const Social = () => {
    ...
    // Theme Colors
    const theme = {
        bg : isDarkMode ? 'bg-gray-900' : 'bhg-gray-50',
